...
<html>
	<head>
        ...
        <!--<meta property="og:url"           content="http://www.zufalplay.com" />
		<meta property="og:type"          content="website" />
		<meta property="og:title"         content="Zufalplay" />
		<meta property="og:description"   content="Play.Win.Buy" />
		<meta property="og:image"         content="http://www.zufalplay.com/images/ss.png" />-->
	</head>
<?php
				        ...
				        $.ajax(
				        {
				          ...
				          success: function(json)
				          {
				            if(json.status==1)
				            {
				              	if(json.user==0)
				            	{
				              		window.location.replace("<?php echo $g_url; ?>welcome.php");
				              	}
				              	else if(json.user==1)
				              	{
				              		location.reload();
		    ...
		    <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
			      ...
			      <ul class="dropdown-menu">
	                ...
	                <?php 
				    if($email == "shreyanspagariya@gmail.com" || $email == "shalvin.shalvin@gmail.com" || $email == "srinivaschakravarthy1996@gmail.com")
					{?>  
