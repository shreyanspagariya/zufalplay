var global_score_var=this.score;
...
function abandon_game()
{
  ...
  window.location.replace("gameabandoned.php");
}
...
GameManager.prototype.move = function (direction) {
  ...
  global_score_var = this.score;

  var zufals_profit = Math.min(20*(this.score/20000)*(this.score/20000),20);
