...
mysqli_query($con,"INSERT INTO handcricket_oneonone (challenge_status,from_user_email,to_user_email,request_time,challenge_id) 
...
mysqli_query($con,"INSERT INTO notifications (to_user,notif_text,notif_href,time_generated) VALUES ('$to_user_email','One-on-One Challenge request from $fnamex.',
    'games/one-on-one/handcricket/game.php?u=$challenge_id','$datetime')");
