  	...
  	<div class="">
        ...
        <div style="margin-top:4px;">
          ...
          <div class="fb-share-button" 
            data-href="https://www.facebook.com/zufalplay/photos/a.495776280585786.1073741827.495739933922754/524426354387445/?type=3&theater" 
            data-layout="button">
          </div>
        </div>
        </li>
...
<body class="zfp-inner">
	...
	<div class="container">
		 <br>
			<h2 align="center"><b>Coil</b> - One on One</h2><hr>
				  ...
				  <table class="table table-bordered table-condensed">
					<thead>
				  	...
				  	<?php
				  		...
				  		$query = "SELECT * from coil_oneonone WHERE 
