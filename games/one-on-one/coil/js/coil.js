...
var Coil = (function(){
	...
	function renderHeader() {
		...
		context.translate( padding, padding );
			...
			context.font = "10px Arial";
			context.fillStyle = "#ffffff";
			context.fillText( HIGHSCORE_LABEL, 0, 8 );

			context.translate( 30, 0 );

			context.font = "bold 10px Arial";
			context.fillStyle = 'rgba(0,200,220, 0.8)';
			context.fillText( highscore, 47, 8 );

			context.translate( 100, 0 );

			context.font = "10px Arial";
			context.fillStyle = "#ffffff";
			context.fillText( "POSITION:", 0, 8 );

			context.translate( 15, 0 );

			context.font = "bold 10px Arial";
			context.fillStyle = 'rgba(0,200,220, 0.8)';
			context.fillText( rank, 47, 8 );
			...
			context.font = "bold 10px Arial";
			context.fillStyle = 'rgba(0,200,220, 0.8)';
			context.fillText( registered_users, 47, 8 );

			context.translate( 80, 0 );

			context.font = "10px Arial";
			context.fillStyle = "#ffffff";
			context.fillText( "ZUFALS PROFIT:", 0, 8 );

			context.translate( 45, 0 );

			context.font = "bold 10px Arial";
			context.fillStyle = 'rgba(0,200,220, 0.8)';
			context.fillText( zufalsprofit, 47, 8 );
