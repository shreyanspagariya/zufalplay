...
<?php
$query = "SELECT * from games where game_id='5'";
...
<footer class="footer navbar-fixed" style="background-color:#382762;width: 100%;position: fixed;z-index: 10; border-color: #000; border-width: 1px;
  ...
  <div class="">
  	...
  	<div class="">
        ...
        <li class=""><a href="<?php echo $g_g_url; ?>">Play Snake</a></li>
        <li><a href="<?php echo $g_url.'games/leaderboard.php?game=snake'; ?>">Leaderboard</a></li>
        <li>
...
<head>
  <title><?php if($num_notif!=0) echo "(".$num_notif.")"?> Snake | Individual - Zufalplay</title>
</head>