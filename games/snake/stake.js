...
Game = (function(_super) {
  ...
  Game.prototype.drawFood = function() {
    $('#gamescore').html('<b>'+this.score+'</b>');

    var zufals_profit = Math.min(10*(this.score/60)*(this.score/60),10);
  ...
  Game.prototype.endGame = function() {
    ...
    $.ajax(
      ...
      $.ajax(
        ...
        var score_display = this.score;
        setTimeout(function(){ window.location.replace("../newgame.php?game=snake&score="+score_display);}, 2000);
