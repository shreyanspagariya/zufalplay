...
<?php
$query = "SELECT * from games where game_id='6'";
$result = mysqli_query($con,$query);
$get = mysqli_fetch_assoc($result);
$gameweek = 0;
$fb_share_link = $get['fb_share_link'];
$g_g_url = $g_url."games/coil/";
global $g_g_url;
global $gameweek;
?>
  ...
  <div class="">
    ...
    <div class="">
      <ul class="nav navbar-nav">
        <li class=""><a href="<?php echo $g_g_url; ?>">Play Coil</a></li>
        <li><a href="<?php echo $g_url.'games/leaderboard.php?game=coil' ?>">Leaderboard</a></li>
        <li>
...
<head>
  <title><?php if($num_notif!=0) echo "(".$num_notif.")"?> Coil | Individual - Zufalplay</title>
</head>