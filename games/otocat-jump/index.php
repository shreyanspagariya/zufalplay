  ...
  <div class="container">
    <div class="col-md-8">
      <ul class="nav navbar-nav">
        <li class=""><a href="<?php echo $g_url.'games/otocat-jump'; ?>">Play <?php echo "Otocat-Jump";?></a></li>
        <li><a href="<?php echo $g_url.'games/leaderboard.php?game=otocat'?>">Leaderboard</a></li>
