...
?>
<head>
<title><?php if($num_notif!=0) echo "(".$num_notif.")"?> Games - Play and Earn @Zufalplay</title>
	...
	<div class="col-md-8">
		<center>
			...
			<?php
				...
				$game_count = mysqli_num_rows($getposts);
