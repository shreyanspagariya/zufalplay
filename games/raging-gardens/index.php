  ...
  <div class="container">
    <div class="col-md-8">
      <ul class="nav navbar-nav">
        <li class=""><a href="<?php echo $g_url.'games/raging-gardens'; ?>">Play <?php echo "Raging-Gardens";?></a></li>
        <li><a href="<?php echo $g_url.'games/leaderboard.php?game=raginggardens'?>">Leaderboard</a></li>
