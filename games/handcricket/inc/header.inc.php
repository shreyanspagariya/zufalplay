...
<?php
$query = "SELECT * from games where game_id='2'";
...
<footer class="footer navbar-fixed" style="background-color:#382762;width: 100%;position: fixed;z-index: 10; border-color: #000; border-width: 1px;
  ...
  <div class="container">
  	<div class="col-md-8">
        ...
        <li class=""><a href="<?php echo $g_g_url; ?>">Play Handcricket</a></li>
        <li><a href="<?php echo $g_url.'games/leaderboard.php?game=handcricket'?>">Leaderboard</a></li>
		    <li>
...
<head>
  <title><?php if($num_notif!=0) echo "(".$num_notif.")"?> Handcricket | Individual - Zufalplay</title>
</head>