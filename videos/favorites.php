...
?>
<head>
<title><?php if($num_notif!=0) echo "(".$num_notif.")"?> Favorites - Zufalplay</title>
...
<body class="zfp-inner">
	...
	<div class="col-md-8 hrwhite">
		<div class="elevatewhite"><hr><h4 align='center'>Favorite Videos</h4><hr></div>
		<center>
					...
					//if(strpos($title1,$search_video_title)!==false || strpos($author_name1,$search_video_title)!==false)
					{
						...
						<tr>
							<td>
								...
								<div class='col-md-10'>
									<a href=$g_url"."videos/video.php?title=".$link_title."&v="."$unique_code><b>$title</b></a><br><br>
