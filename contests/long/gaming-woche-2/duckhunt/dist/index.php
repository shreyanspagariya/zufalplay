  ...
  <div class="container">
    <div class="col-md-8">
      ...
      <li class=""><a href="<?php echo $g_url.'contests/long/gaming-woche-2'; ?>">Contest Arena</a></li>
        <li class=""><a href="<?php echo $g_url.'contests/long/gaming-woche-2/duckhunt/dist'; ?>">Play <?php echo "Duckhunt";?></a></li>
        <li><a href="<?php echo $g_url.'contests/long/localleaderboard.php?game=duckhunt'?>">Local Leaderboard</a></li>
