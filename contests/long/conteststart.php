...
$query = "SELECT * FROM long_contest_leaderboard WHERE contest_id='$contest_id'";
$result = mysqli_query($con,$query);
	...
	<div class="col-md-8">
		<center>
			...
			<div class='elevatewhite' style='padding: 10px;'>
				<h2><i class="fa fa-trophy"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gaming Woche 2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-trophy"></i></h2><hr>
				<h4>1<sup>st</sup> April 2016, 18:15 Hrs IST</h4>
				<h4>5 Games, 100 Hours</h4>
				<hr>
				<!--<h3>Contest begins in</h3>
				<font style='font-size:36px;'><span id='time'></span></font>-->
				<div class='hrwhite' align='center'>
					<font size="4"><b>Contest has ended. <font color='green'>Results Declared</font>.</b></font>
				</div><br>
				<?php
				if($contest_status == -1)
				{
