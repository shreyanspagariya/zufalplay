...
<footer class="footer navbar-fixed" style="background-color:#382762;width: 100%;position: fixed;z-index: 10; border-color: #000; border-width: 1px;
  ...
  <div class="container">
  	<div class="col-md-8">
        ...
        <li><a href="<?php echo $g_url.'contests/long/localleaderboard.php?game='.$game?>">Local Leaderboard</a></li>
...
(adsbygoogle = window.adsbygoogle || []).push({});
		...
		<div class="hrwhite">
			...
			<div class="table-responsive elevatewhite">
			  ...
			  <tbody>
				<?php
				$getposts = mysqli_query($con,"SELECT * FROM game_leaderboard WHERE game_week=0 AND game_id='$game_id' ORDER BY high_score DESC");
				$x=1;
				while($row = mysqli_fetch_assoc($getposts))
				{
					...
					$query = "SELECT * FROM game_playhistory WHERE user_played='$user' AND game_week=0 AND game_id='$game_id'";
					$result = mysqli_query($con,$query);
